...
namespace KProgressHUDLib
{
    public class PieView : View, IDeterminate
    {
        ...
        private void init()
        {
            ...
            mWhitePaint.SetStyle(Paint.Style.FillAndStroke);
            mWhitePaint.StrokeWidth = Helper.DpToPixel(0.1f, Context);
            mWhitePaint.Color = Color.White;

            mGreyPaint = new Paint(PaintFlags.AntiAlias);
            mGreyPaint.SetStyle(Paint.Style.Stroke);
            mGreyPaint.StrokeWidth = Helper.DpToPixel(2, Context);
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            int padding = Helper.DpToPixel(4, Context);
            canvas.DrawCircle(Width / 2, Height / 2, Width / 2 - padding, mGreyPaint);
        }
