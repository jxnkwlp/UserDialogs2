...
namespace Passingwind.UserDialogs
{
    public class UserDialogsImpl // : AbstractUserDialogs
    {
        ...
        //    app.SafeInvokeOnMainThread(() =>
        //    {
        //        SVProgressHUD.ShowInfoWithStatus(options.Message, SVProgressHUDMaskType.Clear);
        //        SVProgressHUD.DismissWithDelay(options.Duration.Milliseconds);
        //    });
        ...
        //    app.SafeInvokeOnMainThread(() =>
        //    {
        //        _snackbar = new TTGSnackbar(options.Message);
        //        _snackbar.Duration = options.Duration;
        //        _snackbar.AnimationType = TTGSnackbarAnimationType.FadeInFadeOut;

        //        //if (options.Position == ToastPosition.Top)
        //        //    _snackbar.LocationType = TTGSnackbarLocation.Top;
        //        //else if (options.Position == ToastPosition.Bottom)
